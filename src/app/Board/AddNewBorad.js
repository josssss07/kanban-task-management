    ...
    <div>
      ...
      >
        <form>
          ...
          <div><input type="text" placeholder="Todo" readOnly  className="w-5/6  text-body-l p-2 border-2 border-[var(--color-lineinput)] rounded-md bg-[var(--color-dialog)]" ></input><Button textColor={"text-medium-grey"} bgColor={"bg-none"} className={"text-heading-l"}>X</Button></div>
          <div><input type="text" placeholder="Doing" readOnly  className="w-5/6  text-body-l p-2 border-2 border-[var(--color-lineinput)] rounded-md bg-[var(--color-dialog)]" ></input><Button  textColor={"text-medium-grey"} bgColor={"bg-none"} className={"text-heading-l"}>X</Button></div>
